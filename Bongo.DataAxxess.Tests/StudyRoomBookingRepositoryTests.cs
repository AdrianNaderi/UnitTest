...
namespace Bongo.DataAccess
{
    ...
    public class StudyRoomBookingRepositoryTests
    {
        ...
        public void SaveBooking_Booking_One_CheckTheValuesFromDatabase()
        {
            ...
            //act
            using (var context = new ApplicationDbContext(options)) // added a entry to Db
            {
            ...
            //assert
            using (var context = new ApplicationDbContext(options)) // extracted entry and cheacked the values
            {
